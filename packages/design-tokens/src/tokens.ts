...
export const primitiveTokens = {
  ...
  'color.neutral.300': '#d0d0cc',
  'color.neutral.500': '#777774',
  'color.neutral.600': '#464644',
  'color.neutral.750': '#292929',
  'color.neutral.850': '#202020',
  'color.neutral.950': '#111111',
  'color.lime.300': '#d7ff4d',
  'color.lime.500': '#b5f300',
  'color.lime.700': '#5d7800',
  'color.blue.300': '#88a0ff',
  'color.blue.700': '#3156d4',
  'color.amber.300': '#ffd166',
  'color.amber.500': '#ffb800',
  'color.amber.700': '#a55f00',
  'color.violet.300': '#c2a7ff',
  'color.violet.700': '#7450d7',
  'color.red.300': '#ff8a80',
  ...
  'typography.font-family.mono': "'Cascadia Mono', Consolas, 'SFMono-Regular', monospace",
  'typography.size.page-title': '28px',
  'typography.size.tool-title': '22px',
  'typography.size.section-title': '16px',
  'typography.size.body': '14px',
  'typography.size.caption': '12px',
  'typography.size.data': '13px',
  'typography.line-height.page-title': '36px',
  'typography.line-height.tool-title': '30px',
